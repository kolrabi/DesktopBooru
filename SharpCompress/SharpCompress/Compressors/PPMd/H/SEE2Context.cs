...
namespace SharpCompress.Compressors.PPMd.H
{
    internal class See2Context
    {
		...
		public virtual int Count { get { return _count; } set { _count = value & 0xff; }}

		public virtual int Shift { get { return _shift; } set { _shift = value & 0xff; }}

		public virtual int Summ { get { return _summ; } set { _summ = value & 0xffff; }}
