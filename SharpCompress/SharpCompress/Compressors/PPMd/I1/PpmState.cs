...
namespace SharpCompress.Compressors.PPMd.I1
{
    ...
    internal struct PpmState
    {
        ...
        /// </summary>
		public byte Symbol { get { return _memory[_address]; } set { _memory[_address] = value; }}

        /// <summary>
        /// Gets or sets the frequency.
        /// </summary>
		public byte Frequency { get { return _memory[_address + 1]; } set { _memory[_address + 1] = value; }}
