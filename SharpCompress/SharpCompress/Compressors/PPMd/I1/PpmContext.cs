namespace SharpCompress.Compressors.PPMd.I1
{
    ...
    internal partial class Model
    {
        ...
        internal struct PpmContext
        {
            ...
            /// </summary>
			public byte NumberStatistics { get { return _memory[_address]; } set { _memory[_address] = value; }}

            /// <summary>
            /// Gets or sets the flags.
            /// </summary>
			public byte Flags { get { return _memory[_address + 1]; } set { _memory[_address + 1] = value; }}
            ...
            {
				get { return (ushort)(_memory [_address + 2] | _memory [_address + 3] << 8); }
                set
                {
            ...
            /// </summary>
			public byte FirstStateSymbol { get { return _memory[_address + 2];} set { _memory[_address + 2] = value; } }
            ...
            /// </summary>
			public byte FirstStateFrequency { get { return _memory[_address + 3]; } set { _memory[_address + 3] = value; }}
